      ...
      <Container>
        <Row className=" my-5">
          <Col xs={12} lg={5} className="text-white text-start">
            <h4 className="mb-0">Contact Me</h4>
            <p>
            ...
            <h5 className="mt-5">
              ...
              <Link style={{ fontSize: "1.3rem" }} to="https://www.linkedin.com/in/giovannigiordanowebdeveloper/">
            ...
            <div>
              <h5 className="mt-3">
                ...
                <Link style={{ fontSize: "1.3rem" }} to="https://github.com/giovgio90">
            ...
            <h5 className="mt-3">
              ...
              <strong className="ms-1">Email:</strong> <br /> giovdevelop90@gmail.com
            </h5>
          </Col>
          <Col xs={12} lg={6} className="ms-auto mt-5 mt-lg-0">
            <div className="text-white text-start">
              <h5>Or send me a message and I will get back to you as soon as possible</h5>
              <div className="form">
                <Form action="https://formspree.io/f/xrgwvgvk" method="POST" className="text-start">
                  <Form.Group controlId="formName" className="mb-3">
                    ...
                    <Form.Control type="text" name="name" placeholder="Insert your name" required />
                  </Form.Group>
                  ...
                  <Form.Group controlId="formMessage">
                    ...
                    <Form.Control as="textarea" name="message" placeholder="Insert your message" required />
                  </Form.Group>
